...
Evaluates reading comprehension where models must resolve references in a question, perhaps to
multiple input positions, and perform discrete operations over them (such as addition,
counting, or sorting).
...
| | |
|---|---|
| Upstream | [`src/inspect_evals/drop`](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/src/inspect_evals/drop) |
| Group | Reasoning |
| Total samples | 9,535 |
...
- `huggingface` — `EleutherAI/drop` (pinned)
